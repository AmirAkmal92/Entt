<Query Kind="Statements">
  ...
  <Reference Relative="..\output\PosEntt.RtsNormTo_normal_console_event_new.dll">D:\project\work\entt.rts\output\PosEntt.RtsNormTo_normal_console_event_new.dll</Reference>
...
var map = new Bespoke.PosEntt.Integrations.Transforms.RtsNormToNormalConsoleEventNew();
