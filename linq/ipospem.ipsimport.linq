<Query Kind="Statements">
  ...
  <Reference Relative="..\output\PosEntt.IposPemToOalIpsImport.dll">C:\project\work\entt.rts\output\PosEntt.IposPemToOalIpsImport.dll</Reference>
...
var map = new Bespoke.PosEntt.Integrations.Transforms.IposPemToOalIpsImport();
