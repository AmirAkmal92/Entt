<Query Kind="Statements">
  ...
  <Reference Relative="..\output\PosEntt.IposPemToEnttAcceptance.dll">C:\project\work\entt.rts\output\PosEntt.IposPemToEnttAcceptance.dll</Reference>
...
//entities.Dump();
var map = new Bespoke.PosEntt.Integrations.Transforms.IposPemToEnttAcceptance();
