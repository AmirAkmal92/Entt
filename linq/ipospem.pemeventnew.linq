<Query Kind="Statements">
  ...
  <Reference Relative="..\output\PosEntt.IposPemToPemEventNew.dll">C:\project\work\entt.rts\output\PosEntt.IposPemToPemEventNew.dll</Reference>
...
var map = new Bespoke.PosEntt.Integrations.Transforms.IposPemToPemEventNew();
