...
{
    public partial class RtsStatToOalIpsImport
    {


        partial void BeforeTransform(Bespoke.PosEntt.Stats.Domain.Stat item, Bespoke.PosEntt.Adapters.Oal.dbo_ips_import destination)
        {

        }

        partial void AfterTransform(Bespoke.PosEntt.Stats.Domain.Stat item, Bespoke.PosEntt.Adapters.Oal.dbo_ips_import destination)
        {
        ...
        private async Task<bool> DoLookupAsync(Bespoke.PosEntt.Stats.Domain.Stat item, Bespoke.PosEntt.Adapters.Oal.dbo_ips_import destination)
        {
